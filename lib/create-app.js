      ...
      host: {
        ...
        authenticate: (authRequest) => {
          ...
          if (session.identified && session.userId) {
            ...
            let signinUrl = url.parse(url.resolve(app.locals.rootUri, '/signin/'))
